...
class LDMXCascadeInterface : public G4CascadeInterface {
 ...
 private:
   ...
   *
   * De-excitation (evaporation, gamma, fission) is handled by G4ExcitationHandler
   * after the cascade and isn't recorded in G4CascadeHistory. Identifies them by
   * comparing final state secondaries against cascade escapees.
   */
